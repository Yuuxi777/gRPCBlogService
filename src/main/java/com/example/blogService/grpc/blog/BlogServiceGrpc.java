...
public final class BlogServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.example.blogService.grpc.blog.BlogRequest,
      com.example.blogService.grpc.blog.BlogResponse> METHOD_GET_BLOG_BY_ID = getGetBlogByIdMethodHelper();

  private static volatile io.grpc.MethodDescriptor<com.example.blogService.grpc.blog.BlogRequest,
      com.example.blogService.grpc.blog.BlogResponse> getGetBlogByIdMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.example.blogService.grpc.blog.BlogRequest,
      com.example.blogService.grpc.blog.BlogResponse> getGetBlogByIdMethod() {
    return getGetBlogByIdMethodHelper();
  }

  private static io.grpc.MethodDescriptor<com.example.blogService.grpc.blog.BlogRequest,
      com.example.blogService.grpc.blog.BlogResponse> getGetBlogByIdMethodHelper() {
    io.grpc.MethodDescriptor<com.example.blogService.grpc.blog.BlogRequest, com.example.blogService.grpc.blog.BlogResponse> getGetBlogByIdMethod;
      ...
      synchronized (BlogServiceGrpc.class) {
        if ((getGetBlogByIdMethod = BlogServiceGrpc.getGetBlogByIdMethod) == null) {
          BlogServiceGrpc.getGetBlogByIdMethod = getGetBlogByIdMethod = 
              io.grpc.MethodDescriptor.<com.example.blogService.grpc.blog.BlogRequest, com.example.blogService.grpc.blog.BlogResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BlogService", "GetBlogById"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.blogService.grpc.blog.BlogRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.blogService.grpc.blog.BlogResponse.getDefaultInstance()))
  ...
  public static abstract class BlogServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBlogById(com.example.blogService.grpc.blog.BlogRequest request,
        io.grpc.stub.StreamObserver<com.example.blogService.grpc.blog.BlogResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.blogService.grpc.blog.BlogRequest,
                com.example.blogService.grpc.blog.BlogResponse>(
  ...
  public static final class BlogServiceBlockingStub extends io.grpc.stub.AbstractStub<BlogServiceBlockingStub> {
    ...
    /**
     */
    public com.example.blogService.grpc.blog.BlogResponse getBlogById(com.example.blogService.grpc.blog.BlogRequest request) {
  ...
  public static final class BlogServiceFutureStub extends io.grpc.stub.AbstractStub<BlogServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.blogService.grpc.blog.BlogResponse> getBlogById(
        com.example.blogService.grpc.blog.BlogRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BLOG_BY_ID:
          serviceImpl.getBlogById((com.example.blogService.grpc.blog.BlogRequest) request,
              (io.grpc.stub.StreamObserver<com.example.blogService.grpc.blog.BlogResponse>) responseObserver);
          break;
        default:
